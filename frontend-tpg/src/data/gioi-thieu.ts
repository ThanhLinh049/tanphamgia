...
/** 2.1 Page Header */
export const gioiThieuHeader = {
  eyebrow: 'Về Tân Phạm Gia',
  title: 'Hành trình kiến tạo',
  desc: 'Hơn 23 năm kinh nghiệm trong ngành may mặc — từ thời trang cao cấp đến giải pháp đồng phục doanh nghiệp toàn diện.',
...
export const productionCapacity = {
  ...
  /** 2 khối zig-zag: quy mô xưởng + QC — render qua ZigzagBlock dùng chung */
  blocks: [
    {
      image:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuD7szr7Elx-oAqCEnir2uiBqNE-4WpmIm10Kj1YsgXyu1XMFvP0qvIXYrsMpRh9sztusxsq8_7_MFPstpomb4RaDeTg9J3ldf2CSKwYUq91qGdHVM6Dm9YkfE3Rdfay_snBPthtK7WWCq_NFHZ3j3Kua1MgJAT-qQPXwlpAIQIDLIpk4Njn_msEnsXh9DyyRtwkvdNU5u10NXpGyYseM_HBo6gwnr6IFqeZ9gHXI1CrvRQnXAxx3UyIT7UIbTDEMKjd1gdxbZwWKrKl',
      alt: 'Nhà xưởng Tân Phạm Gia',
    ...
    },
    {
      ...
      desc: 'Quy trình kiểm tra nghiêm ngặt từ: Sợi vải đầu vào, Cắt vải, May bán thành phẩm, Hoàn thiện và Kiểm định đóng gói cuối cùng.',
